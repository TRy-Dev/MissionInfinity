...
func shake():
	...
	offset.x = SHAKE_MAX_OFFSET.x * amount * noise.get_noise_2d(noise.seed + 10, noise_y)
	offset.y = SHAKE_MAX_OFFSET.y * amount * noise.get_noise_2d(noise.seed + 100, noise_y)
